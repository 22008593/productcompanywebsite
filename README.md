        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="man1"><p align="center"><b><h2>Cristiano Ronaldo</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>Lionel Messi</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>Neymar</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>Mbappe</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>Lewandowski</h2></b></p></div><br>
...
<html lang="en">
    <head>
        ...
        .ph1{
            background-image: url(/static/img/lipstick.png);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .ph2{
            background-image: url(/static/img/foundation.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .ph3{
            background-image: url(/static/img/eyeliner.png);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .ph4{
            background-image: url(/static/img/makeupbrush.jpeg);
            background-position-x: center;
            border:1px solid black;
            height:200px;
            width:30%;
        ...
        .ph5{
            background-image: url(/static/img/compactpowder.jpeg);
            background-position-x: center;
            border:1px solid black;
            height:200px;
            width:30%;
        ...
        .ph6{
            background-image: url(/static/img/primer.jpeg);
            background-position-x: center;
            border:1px solid black;
            height:200px;
            width:30%;
